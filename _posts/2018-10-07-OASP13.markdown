...
LTE的东西当然比较好用，不过最近在华沙的一个Gaia Workshop里面Maria Bergermann把LTE批判了一番，说nLTE对于元素丰度确定来说很重要。
...
实际计算用的是$$ (7.15) $$，但是要加上谱线的吸收系数。$$ (13.15), (13.16) $$还没完全理解就不放上来了，毕竟这本书也没有涉及到具体详细的计算方法。
